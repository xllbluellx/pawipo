...
<div class="row centered">
	<div class="col col-10">
		<div id="modal-tutorados-baja" class="animated bounceInRight">
		    <div class="modal" style="border: 1px solid #DDD;">
		        <div class="modal-header gradient">Baja de alumno<br><span class="label tag error">Todos los campos son obligatorios</span></div>
		        <div class="modal-body">
			        <form class="form" id="modal-tutorados-baja">
			        		<div class="row centered">
			        			<div class="col col-7">
			        				 <div class="form-item">
