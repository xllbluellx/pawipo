	...
	<div class="col col-10">
		<div id="administrador-administrar" class="animated bounceInRight">
		    <div class="modal" style="border: 1px solid #DDD;">
		        <div class="modal-header gradient">Cambiar contraseña de alumno<br><span class="label tag error">Todos los campos son obligatorios</span></div>
			        		...
			        		<div class="row centered">
			        			<div class="col col-7">
			        				 <div class="form-item">
								        ...
								        <input data-tipso="Escribe el Número de control" type="text" id="id" name="id">
								    </div>
								    <div class="form-item">
