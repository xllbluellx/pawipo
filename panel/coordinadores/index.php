...
//Se inicia sesión para validar que el usuario siga siendo el mismo y no entre otro más.
    session_start();
    if(!isset($_SESSION['coordinador'])){ //En caso de que no variable de sesión, redireciona.
    header("location: ../../");
    }
    setcookie('tipo', 'administrador', 0, '/');
?>
<!DOCTYPE html>
<html>
<head>
    <title>TADDI: COORDINADOR</title>
    <meta charset="utf-8">
...
<div class="row">
    ...
    <div class="sidebar">
    	...
    	<a  class="collapse-toggle button oscuro width-100" style="background: #2E2E2E;"><i class="fa fa-graduation-cap fa-lg"></i>
    	COORDINADOR</a>
    ...
    <div class="col col-9">
		...
		<div id="ContenedorPrincipal" class="contenedorPrincipal gradient" >
		    ...
		    <div class="titulos">Bienvenido(a) al área administrativa <b><?php echo strtoupper($_COOKIE['quien']); ?>
		    </b>
		    </div>
		    </div>
			</div>
