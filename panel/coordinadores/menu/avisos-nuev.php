		...
		<div id="modal-avisos-nuev" class="animated bounceInRight">
		    <div class="modal" style="border: 1px solid #DDD;">
		        ...
		        <div class="modal-body">
			        <form class="form" id="modal-avisos-nuev">
						    <div class="form-item">
						        <label>Aviso</label>
						    ...
						    <div class="form-item checkboxes-inline">
						    	  <label><input type="checkbox" id="aquien" name="Tutorado" value="Tutorado"> Tutorados</label>
						        <label><input type="checkbox" id="aquien" name="Tutor" value="Tutor"> Tutores</label>
						        <label><input type="checkbox" id="aquien" name="Coordinador" value="Coordinador"> Coordinadores</label>
						    </div>
