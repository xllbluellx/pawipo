...
<div class="row centered">
	<div class="col col-11">
		<div id="modal-form-1" class="animated bounceInRight">
		    <div class="modal" style="border: 1px solid #DDD;">
		        ...
		        <div class="modal-body">
			        <form class="form" id="modal-form-1">
			        		<div class="row">
			        				...
			        				<div class="row centered">
			        					<div class="col col-6 hoverBtn">
											<div class="divbutton">
												...
												<?php
												session_start();
													foreach(glob("../../img/img_".$_SESSION['alumno'].".*") as $file){
													$f = substr($file, 3);
													echo '<img id="preview" src="'.$f.'" style="height: 100%; width: 100%; object-fit: contain" class="animated" alt="Imagen de  Perfil" />';
													break;
													}
												?>
			        					</div>
								    ...
								    <div class="row">
										<div class="col">							    
										    <div id="msj" class="form-item">
										        ...
										        <input data-tipso="Ejemplo: 1.70" type="number" id="estatura" name="estatura" class="width-100">
										    </div>
										</div>
										<div class="col">
											 <div id="msj" class="form-item">
										        <label>Peso</label>
										        <input data-tipso="Ejemplo: 60.5" type="number" id="peso" name="peso" class="width-100">
										    </div>
										</div>								    
								    </div>
			        			...
			        			<div class="col col-5 offset-1 anexosBox">
			        			 <div class="form-item">
								    ...
								    <div class="row">
								    	<div class="col col-7">
								    		<div class="form-item">
										    <button type="submit" class="button aceptar width-100" name="1-1" id="generarPDF">Generar PDF <i class="fa fa-check fa-lg"></i></button>
										    </div>
								    	</div>
										<div class="col">
										    <div class="form-item">
								                ...
								                success: function (infoRegreso) {
								                	if (!$.isNumeric(infoRegreso)) {
								                		llenarForm('modal-'+$.cookie('subop'), $.parseJSON(infoRegreso));
								                			...
								                			$('div#ContenedorPrincipal').html('<div class="alert error animated fadeInDown"><i class="fa fa-warning fa-2x"></i> <b>No has realizado el Formato de Entrevista 1, realizalo antes de consultar.</b></div>');
								                		}
								                	}
								            });
						    	});
