...
<div class="row centered">
	<div class="col col-10">
		<div id="administrador-administrar" class="animated bounceInRight">
		    <div class="modal" style="border: 1px solid #DDD;">
		        <div class="modal-header gradient">Cambiar mi contraseña actual<br><span class="label tag error">Todos los campos son obligatorios</span></div>
		        <div class="modal-body">
			        <form class="form" id="administrador-administrar">
			        		<div class="row centered">
			        			<div class="col col-7">
			        				 <div class="form-item">
								        <label>Contraseña actual</label>
								        <input data-tipso="Escribe tu actual contraseña" type="password" id="old-pass" name="old-pass">
								    </div>
								    <div class="form-item">
