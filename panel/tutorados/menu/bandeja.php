	...
	<div class="col">
		<div id="modal-email" class="animated bounceInRight">
		    <div class="modal" style="border: 1px solid #DDD;">
		        <div class="modal-header gradient">Bandeja de Entrada<br><span class="label tag error">Citas / Mensajes de tu Tutor(a)</span></div>
		        <div class="modal-body">
			        <form class="form" id="modal-email">
							...
							ob_start();
								...
								$msj = new Bandejas();
								echo $msj->bandejaAlumno($_SESSION['alumno']);
							?>
