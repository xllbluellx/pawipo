...
<div class="row centered">
	<div class="col col-6">
		<div id="modal-tutor" class="animated bounceInLeft">
		    <div class="modal" style="border: 1px dashed #BBB;">
		        <div class="modal-header">Tutor<br><span class="label tag error">Todos los campos son obligatorios</span></div>
		        <div class="modal-body">
			        <form class="form" id="modal-tutor">
						    <div class="form-item">
						        <label>Usuario</label>
